...
- 📚 My research interests are in ```Machine Learning``` and ```Data Mining```. I like to develop machine learning models to solve tasks. Currently working in the ```Bioinformatics``` domain, playing with biological data. 
